...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    void Start()
    {
        ...
        DeathArea = (Vector2)CenterReference.position - joyStick.pivot * joyStick.sizeDelta;
    ...
    public void OnDrag(PointerEventData data)
    {
        ...
        if (data.pointerId == lastId)
        {
            ...
            Vector2 position = bl_JoystickUtils.TouchPosition(m_Canvas,GetTouchID);
    ...
    public Vector2 Direction
    {
        get
        {
            ...
            return !onHold ? Vector2.zero : direction.normalized;
        }
    }
